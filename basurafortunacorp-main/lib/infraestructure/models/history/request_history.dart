class RequestHistory {
  ...
  String origin;
  String picture;
  RecyclingRequestDetail recyclingRequestDetail;
  String updated;
  ...
  RequestHistory({
    ...
    required this.recyclingRequestDetail,
  ...
  factory RequestHistory.fromJson(Map<String, dynamic> json) {
    return RequestHistory(
      ...
      recyclingRequestDetail:
      RecyclingRequestDetail.fromJson(json['recyclingRequest']),
      updated: json['updated'],
    );
  }
}

class RecyclingRequestDetail {
  String created;
  String description;
  int estimatedWeight;
  int id;
  ...
  factory RecyclingRequestDetail.fromJson(Map<String, dynamic> json) {
    return RecyclingRequestDetail(
      created: json['created'],
      description: json['description'],
